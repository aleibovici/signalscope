...
export function buildWeeklyDigestHtml(
  ...
  const ctaSection = `<p style="margin:16px 0 8px;font-size:13px;color:#6b7280;">
...
export async function sendWeeklyDigest(): Promise<{
  ...
  console.log(
    `[email/weekly] Done: ${sent} sent, ${skipped} failed, ${topTickers.length} top performers`
  );
