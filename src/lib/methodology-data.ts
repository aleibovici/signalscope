...
export const methodologyDescription =
  ...
  "13-flag pump-and-dump filter, and validates signal quality against a LightGBM ML backtesting pipeline trained on historical breakout outcomes across 293 engineered features. " +
...
export const backtestDescription =
  ...
  "LightGBM regression model (depth 2, 40 estimators) on 3-day forward returns across 293 engineered features — " +
  "EWMA historical cross-products, P&D flag history, short-float and float-size interactions, and scan-level " +
  "aggregates. Only about 10 of the 293 features carry non-zero importance, with pnd_micro_cap_no_catalyst emerging " +
  "as the dominant single predictor. The model is evaluated on 1-, 3-, and 7-day horizons; feature importance " +
  "analysis identifies which factors drive accuracy and feeds back into AI score thresholds, stage assignments, " +
  "and pump-and-dump detection — so the platform gets smarter with every scan.";

export const backtestPipeline = [
  "Price snapshots (open & close)",
  "Return computation (1d, 3d, 7d, 30d)",
  "Feature engineering (293 features, EWMA cross-products)",
