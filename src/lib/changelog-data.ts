  ...
  },
  {
    ...
    changes: [
      ...
      },
      {
        category: "fixed",
        items: [
          "Live Alpaca paper trading endpoint is now reachable without a session, matching its design as a single shared SignalScope-owned account. Anonymous web visitors no longer hit a 401.",
        ],
      },
    ],
  },
    ...
    changes: [
      {
        category: "new",
        items: [
          "Public /api/changelog endpoint — clients can fetch the changelog programmatically.",
        ],
      },
      {
        category: "improved",
    ...
    changes: [
      {
        category: "new",
        items: [
          "Published skill discovery index at /.well-known/agent-skills/index.json listing all three API skill files with SHA-256 digests.",
          ...
          "Mobile bottom tab bar for one-thumb navigation between Signals, Trending, Results, Portfolio, and Profile (mobile safe-area aware).",
        ],
      },
      {
        category: "improved",
    ...
    changes: [
      {
        ...
        items: [
          ...
          "API skill file: connect any compatible LLM or agent client to your SignalScope account via the downloadable skill docs.",
