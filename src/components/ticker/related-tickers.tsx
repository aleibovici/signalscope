  ...
  return (
    <Card>
      <div className="px-4 py-3 sm:px-6 sm:py-4">
        <h3 className="font-semibold text-gray-900 dark:text-zinc-100">Related tickers</h3>
        <p className="mt-0.5 text-xs text-gray-500 dark:text-zinc-500">
          Tickers that frequently appear in the same scans
        </p>
      </div>
      <div className="border-t border-gray-100 px-4 pb-4 dark:border-zinc-800 sm:px-6 sm:pb-6">
