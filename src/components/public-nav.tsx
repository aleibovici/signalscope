      ...
      <div className={`mx-auto flex items-center justify-between px-4 py-3 sm:px-6 ${maxWidth}`}>
        <div className="flex items-center gap-6">
          ...
          <div className="hidden items-center gap-4 sm:flex">
            <Link href="/blog" className="text-sm text-blue-200 hover:text-white transition-colors">Blog</Link>
            <Link href="/faq" className="text-sm text-blue-200 hover:text-white transition-colors">FAQ</Link>
            <Link href="/how-it-works" className="text-sm text-blue-200 hover:text-white transition-colors">Methodology</Link>
            <Link href="/changelog" className="text-sm text-blue-200 hover:text-white transition-colors">Changelog</Link>
          </div>
        </div>
        <Link
          href="/login"
