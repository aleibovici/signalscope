...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    title: "Results",
    body: "Two views in one: Signal Quality tracks real win rates and returns for every AI-scored pick. Simulated Portfolio shows what $1k per signal would have made vs. the S&P 500.",
    placement: "right",
    requiresSidebar: true,
  },
  {
