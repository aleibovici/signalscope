...
export async function GET(
  ...
  try {
    ...
    // 2. Get appearance count per co-occurring symbol for Jaccard
    ...
    // 3. Fetch latest record per co-occurring symbol
    ...
    // 5. Build results — only include symbols that have a matching latest record
