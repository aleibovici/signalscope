    ...
    <PublicPageLayout>
      <article className="prose prose-gray max-w-none">
        ...
        <p className="mt-6 text-gray-700">
          ...
          <a href="https://signalscopes.com" className="text-blue-600 hover:underline">
            signalscopes.com
          </a>
        ...
        <h2 className="mt-10 text-xl font-semibold text-gray-900">What we collect</h2>
        ...
        <h2 className="mt-10 text-xl font-semibold text-gray-900">How we use it</h2>
        <p className="mt-3 text-gray-700">
        ...
        <h2 className="mt-10 text-xl font-semibold text-gray-900">Cookies</h2>
        <p className="mt-3 text-gray-700">
        ...
        <h2 className="mt-10 text-xl font-semibold text-gray-900">Security &amp; retention</h2>
        <p className="mt-3 text-gray-700">
        ...
        <h2 className="mt-10 text-xl font-semibold text-gray-900">Your choices</h2>
        <p className="mt-3 text-gray-700">
