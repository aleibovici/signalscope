...
Rate limits: 1,000 calls/day by default. When optional Stripe billing is enabled on a deployment, unauthenticated-tier keys are limited to 10 calls/calendar month.
