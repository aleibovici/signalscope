...
**Rate limits:** 1,000 calls/day by default. Deployments with optional Stripe billing enabled may apply a 10 calls/calendar month limit without an active subscription.
...
- For high-volume agent use cases, x402 micropayments may be more cost-efficient than maintaining your own deployment infrastructure
